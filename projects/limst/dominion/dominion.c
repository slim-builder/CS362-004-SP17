...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return playAdventurer(handPos, currentPlayer, state, drawntreasure, temphand, z, cardDrawn);
			
    case council_room:
      return playCouncilRoom(handPos, currentPlayer, state);
    ...
    case minion:
      return playMinion(handPos, currentPlayer, state, choice1, choice2);
    ...
    case sea_hag:
      return playSeaHag(handPos, currentPlayer, state);
...
int playAdventurer(int handPos, int currentPlayer, struct gameState *state, int drawntreasure, int temphand[], int z, int cardDrawn) {
...
int playMinion(int handPos, int currentPlayer, struct gameState *state, int choice1, int choice2) {
      int i, j;
      //+1 action
      state->numActions++;
